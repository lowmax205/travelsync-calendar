...
class _AuthResetPasswordWidgetState extends State<AuthResetPasswordWidget>
  ...
  void initState() {
    ...
    _model.confirmresetPasswordTextController ??= TextEditingController();
    _model.confirmresetPasswordFocusNode ??= FocusNode();
                          ...
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 8.0, 0.0, 24.0),
                              child: Text(
                                'Enter your new password in the textbox below.',
                            ...
                            Padding(
                              ...
                              child: SizedBox(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.confirmresetPasswordTextController,
                                  focusNode:
                                      _model.confirmresetPasswordFocusNode,
                                  autofocus: true,
                                  autofillHints: const [AutofillHints.email],
                                  obscureText: false,
                                  decoration: InputDecoration(
