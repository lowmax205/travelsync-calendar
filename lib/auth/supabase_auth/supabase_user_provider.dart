...
class TravelSyncCalendarSupabaseUser extends BaseAuthUser {
  TravelSyncCalendarSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> travelSyncCalendarSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = TravelSyncCalendarSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
