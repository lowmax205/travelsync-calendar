                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child:
                                  FutureBuilder<List<UserBasicInformationRow>>(
                                future:
                                    UserBasicInformationTable().querySingleRow(
                                  queryFn: (q) => q,
                                ),
                                builder: (context, snapshot) {
                                  ...
                                  if (!snapshot.hasData) {
                                    return Image.asset(
                                      imageUserBasicInformationRow!
                                          .profileLink!,
                                    );
                                  }
                                  List<UserBasicInformationRow>
                                      imageUserBasicInformationRowList =
                                      snapshot.data!;
                                  ...
                                  final imageUserBasicInformationRow =
                                      imageUserBasicInformationRowList
                                              .isNotEmpty
                                          ? imageUserBasicInformationRowList
                                              .first
