...
class _ProfilePageWidgetState extends State<ProfilePageWidget>
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UserTbRow>>(
      future: UserTbTable().querySingleRow(
      ...
      builder: (context, snapshot) {
        ...
        List<UserTbRow> profilePageUserTbRowList = snapshot.data!;

        final profilePageUserTbRow = profilePageUserTbRowList.isNotEmpty
            ? profilePageUserTbRowList.first
            : null;
